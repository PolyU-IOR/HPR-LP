# Contributing to GPU Presolver

Thank you for your interest in contributing to GPU Presolver!
...
```
feat(presolve): add new GPU presolve rule

Implement a new presolve rule for large-scale LP/QP problems
that reduces model size before downstream solves.
